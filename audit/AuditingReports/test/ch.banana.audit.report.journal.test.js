...
AuditReports_Journal.prototype.testGeneralLedgerReport = function() {
    ...
    var startDate = "2021.01.01";
    var endDate = "2022.12.31";
    userParam.journal.xmlColumnsName=["Notes", "AccountDebit", "AccountCredit"];
    var report = printReport(startDate, endDate, userParam, banDoc_withVAT);
    ...
    var startDate = "2021.01.01";
    var endDate = "2022.12.31";
    userParam.journal.xmlColumnsName = ["VatRate", "VatRateEffective", "VatTaxable", "VatAmount"];
    var report = printReport(startDate, endDate, userParam, banDoc_withVAT);
    ...
    var startDate = "2021.01.01";
    var endDate = "2022.12.31";
    userParam.journal.xmlColumnsName = ["ContraAccount", "AccountDebitDes", "AccountCreditDes"];
    var report = printReport(startDate, endDate, userParam, banDoc_withoutVAT);
...
function initUserParam(){
    var userParam={};
    userParam.journal={};
    userParam.journal.xmlColumnsName=[];//test all the accounts, also those without transactions
