...
function exec() {
    ...
    if(userParam && banDoc){
        ...
        avgCost=getAverageCost(userParam.selectedItem,banDoc,multiCurrencyAcc,currentSelectionTop);
...
function createSharesSalesOpDocChange(currentSelectionBottom,avgCost,sharesData,multiCurrencyAccounting,userParam){
    ...
    rows.push(createSharesSalesOpDocChange_bankCharges(jsonDoc,currentSelectionBottom,userParam,amountColumn));
    rows.push(createSharesSalesOpDocChange_profitOrLoss(jsonDoc,sharesData,currentSelectionBottom,userParam,amountColumn));
...
function createSharesSalesOpDocChange_bankCharges(jsonDoc,currentSelectionBottom,userParam,amountColumn){
...
function createSharesSalesOpDocChange_profitOrLoss(jsonDoc,sharesData,currentSelectionBottom,userParam,amountColumn){
...
function createSharesSalesOpDocChange_sharesSale(jsonDoc,avgCost,currentSelectionBottom,userParam){
        ...
        row.fields.UnitPrice=opAvgCost;
