...
function exec(inData, banDoc, isTest) {
    ...
    let arrData = Banana.Converter.csvToArray(inData, convertionParam.separator, convertionParam.textDelim);
    ...
    let jsonDoc = getDocChange(banDoc, arrData);
