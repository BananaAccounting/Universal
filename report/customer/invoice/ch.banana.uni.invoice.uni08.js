...
// @description.de = Stil 8: Summenspalte, Logo, 2 Farben
// @description.fr = Style 8: colonne Total, logo, 2 couleurs
// @description.nl = Stijl 8: kolom Totaal, logo, 2 kleuren
// @description.en = Style 8: Total column, logo, 2 colors
// @description.zh = 样式 8: 总列, 标志, 2 颜色
// @doctype = *
...
function printItemsHeader(invoiceObj, repDocObj, param, texts, rowNumber) {
  ...
  dd.addCell("", "doc_table_header", 1);
  dd.addCell("", "doc_table_header amount", 1);
  dd.addCell(texts.total + " " + invoiceObj.document_info.currency, "doc_table_header amount", 1);
}
