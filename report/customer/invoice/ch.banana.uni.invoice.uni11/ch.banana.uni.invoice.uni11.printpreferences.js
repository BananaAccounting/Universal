...
function getPrintPreferences() {
  ...
  switch(lang){
    ...
    case "de":
      ...
      break;
    case "nl":
      printPreferences = getPrintPreferences_nl();
      break;
    case "zh":
      printPreferences = getPrintPreferences_zh();
      break;
    default:
      printPreferences = getPrintPreferences_en();
      break;
...
function getPrintPreferences_nl() {
  let printOptions_nl =
  {
    "version" : "1.0",
    "id": "invoice_available_print_preferences",
    "text":"Voorkeuren voor afdrukken",
    "base_options" : [
      {
        "id": "print_formats",
        "text": "Afdrukformaten",
        "formats": [
          ...
          {
            "id":"delivery_note" ,
            "text": "Leveringsbon met bedragen"
          },
          {
            "id":"delivery_note_without_amounts",
            "text":"Leveringsbon zonder bedragen"
          },
          {
            "id":"reminder_1",
            "text": "1e herinnering"
  ...
  return printOptions_nl;
}

function getPrintPreferences_zh() {
  let printOptions_zh =
  {
    "version" : "1.0",
    "id": "invoice_available_print_preferences",
