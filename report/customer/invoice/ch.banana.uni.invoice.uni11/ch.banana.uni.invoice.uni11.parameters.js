...
/* User parameters update: 2024-12-16 */
  ...
  if (parseInt(index) == 1) {
    ...
    for (var i = 0; i < userParam.data.length; i++) {
      if (userParam.data[i].name === 'details_columns') {
        ...
        userParam.data[i].value = 'Beschrijving;Hoeveelheid;Eenheid;Eenheidsprijs;%BTW;Bedrag';
      }
      else if (userParam.data[i].name === 'zh_text_details_columns') {
        userParam.data[i].value = '摘要;数量;单位;单价;%增值税率;金额';
      }
    }
  }
