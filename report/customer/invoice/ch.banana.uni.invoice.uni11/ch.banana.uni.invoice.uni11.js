...
// Define the required version of Banana Accounting
...
function printInvoice(banDoc, repDocObj, texts, userParam, repStyleObj, invoiceObj, variables, preferencesObj) {
  ...
  */
  ...
  if (BAN_ADVANCED && userParam.dev_show_json) {
    showInvoiceJsons(banDoc, invoiceObj, preferencesObj, userParam, texts);
  }
...
function showInvoiceJsons(banDoc, invoiceObj, preferencesObj, userParam, texts) {
