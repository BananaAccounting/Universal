...
// @id = ch.banana.uni.invoice.template3.test
// @api = 1.0
// @pubdate = 2018-01-15
// @publisher = Banana.ch SA
// @description = <TEST ch.banana.uni.invoice.template3.js>
// @task = app.command
// @doctype = *.*
// @docproperties = 
// @outputformat = none
// @inputdataform = none
// @includejs = ../ch.banana.uni.invoice.template3.js
// @timeout = -1
...
Test.registerTestCase(new ReportInvoiceTemplate3());

// Here we define the class, the name of the class is not important
function ReportInvoiceTemplate3() {

}

// This method will be called at the beginning of the test case
ReportInvoiceTemplate3.prototype.initTestCase = function() {

}

// This method will be called at the end of the test case
ReportInvoiceTemplate3.prototype.cleanupTestCase = function() {

}

// This method will be called before every test method is executed
ReportInvoiceTemplate3.prototype.init = function() {

}

// This method will be called after every test method is executed
ReportInvoiceTemplate3.prototype.cleanup = function() {

}

// All methods starting wiht 'test' will be executed
ReportInvoiceTemplate3.prototype.test1 = function() {
   //Test.logger.addKeyValue("key1", "test1");
}

ReportInvoiceTemplate3.prototype.test2 = function() {
   //Test.logger.addKeyValue("key1", "test2");
}

ReportInvoiceTemplate3.prototype.testReport = function() {
   
  Test.logger.addComment("Test ch.banana.uni.invoice.template3.js");
