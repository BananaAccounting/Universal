...
// @id = ch.banana.report.customer.invoice.style01.test.js
// @api = 1.0
// @pubdate = 2018-01-05
// @publisher = Banana.ch SA
// @description = <TEST ch.banana.report.customer.invoice.style01.js>
// @task = app.command
// @doctype = *.*
// @docproperties = 
// @outputformat = none
// @inputdataform = none
// @includejs = ../ch.banana.report.customer.invoice.style01.js
// @timeout = -1
...
Test.registerTestCase(new ReportCustomerInvoiceStyle01());

// Here we define the class, the name of the class is not important
function ReportCustomerInvoiceStyle01() {

}

// This method will be called at the beginning of the test case
ReportCustomerInvoiceStyle01.prototype.initTestCase = function() {

}

// This method will be called at the end of the test case
ReportCustomerInvoiceStyle01.prototype.cleanupTestCase = function() {

}

// This method will be called before every test method is executed
ReportCustomerInvoiceStyle01.prototype.init = function() {

}

// This method will be called after every test method is executed
ReportCustomerInvoiceStyle01.prototype.cleanup = function() {

}

// All methods starting wiht 'test' will be executed
ReportCustomerInvoiceStyle01.prototype.test1 = function() {
   //Test.logger.addKeyValue("key1", "test1");
}

ReportCustomerInvoiceStyle01.prototype.test2 = function() {
   //Test.logger.addKeyValue("key1", "test2");
}

ReportCustomerInvoiceStyle01.prototype.testReport = function() {
   
  Test.logger.addComment("Test ch.banana.report.customer.invoice.style01.js");
