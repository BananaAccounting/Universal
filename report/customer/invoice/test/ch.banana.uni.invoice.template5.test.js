...
// @id = ch.banana.uni.invoice.template5.test
// @api = 1.0
// @pubdate = 2018-01-15
// @publisher = Banana.ch SA
// @description = <TEST ch.banana.uni.invoice.template5.js>
// @task = app.command
// @doctype = *.*
// @docproperties = 
// @outputformat = none
// @inputdataform = none
// @includejs = ../ch.banana.uni.invoice.template5.js
// @timeout = -1
...
Test.registerTestCase(new ReportInvoiceTemplate5());

// Here we define the class, the name of the class is not important
function ReportInvoiceTemplate5() {

}

// This method will be called at the beginning of the test case
ReportInvoiceTemplate5.prototype.initTestCase = function() {

}

// This method will be called at the end of the test case
ReportInvoiceTemplate5.prototype.cleanupTestCase = function() {

}

// This method will be called before every test method is executed
ReportInvoiceTemplate5.prototype.init = function() {

}

// This method will be called after every test method is executed
ReportInvoiceTemplate5.prototype.cleanup = function() {

}

// All methods starting wiht 'test' will be executed
ReportInvoiceTemplate5.prototype.test1 = function() {
   //Test.logger.addKeyValue("key1", "test1");
}

ReportInvoiceTemplate5.prototype.test2 = function() {
   //Test.logger.addKeyValue("key1", "test2");
}

ReportInvoiceTemplate5.prototype.testReport = function() {
   
  Test.logger.addComment("Test ch.banana.uni.invoice.template5.js");
