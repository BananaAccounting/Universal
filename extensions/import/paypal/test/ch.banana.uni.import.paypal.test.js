...
// @id = ch.banana.uni.import.paypal.test
// @api = 1.0
// @pubdate = 2021-03-24
// @publisher = Banana.ch SA
// @description = <TEST ch.banana.uni.import.paypal.test>
// @task = app.command
// @doctype = *.*
// @docproperties = 
// @outputformat = none
// @inputdataform = none
// @includejs = ../ch.banana.uni.import.paypal.js
// @timeout = -1

// Register test case to be executed
Test.registerTestCase(new TestImportPaypal());

// Here we define the class, the name of the class is not important
function TestImportPaypal() {
}
